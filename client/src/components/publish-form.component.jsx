...
const PublishForm = () => {
  ...
  const publishBlog = (e) =>{
   ...
   return (
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16  lg:gap-4"> {/* Ensure relative parent */}
        <Toaster />
        <button
        ...
        <div className="border-grey lg:border-1 lg:pl-8 " >
            <p className="text-dark-grey mb-2 mt-9 ">Blog Tittle</p>
            ...
            <div className="relative input-box pl-2 py-2 pb-4 ">
              <input type="text" placeholder="Topics" className="sticky input-box bg-white top-0 bottom-0 pl-4 mb-3 focus:bg-white"
              ...
              <p className="text-dark-grey mb-4 mt-1 text-right">{tagLimit - tags.length} Tags Left </p>
